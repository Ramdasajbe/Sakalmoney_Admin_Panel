  ...
  const [data, setData] = useState([
    {
      ...
      status: "Active",
      updatedBy: [],
      vehicleName: "LAND CRUISER TOYOTA",
      vehicleNo: "MH12GR0010",
      vehicleType: "PVT CAR",
      __1: "",
      __2: "",
      __3: "",
      _id: "628df39c3fcd87b668837603",
    },
    {
      "": "",
      agencyName: "SAKAAL PAPERS LTD.",
      ...
      status: "Active",
      updatedBy: [],
      vehicleName: "INNOVA TOYOTA",
      vehicleNo: "MH12MB8228",
      vehicleType: "PVT CAR",
      __1: "",
      __2: "",
      __3: "",
      _id: "628df39c3fcd87b668837604",
    },
    {
      "": "",
      agencyName: "SAKAAL PAPERS LTD.",
      ...
      status: "Active",
      updatedBy: [],
      vehicleName: "SCORPIO M2DICR MAHINDRA & MAHINDRA",
      vehicleNo: "MH40KR1667",
      vehicleType: "PVT CAR",
      __1: "",
      __2: "",
      __3: "",
      _id: "628df39c3fcd87b668837605",
    },
    {
      "": "",
      agencyName: "SAKAAL PAPERS LTD.",
      ...
      status: "Active",
      updatedBy: [],
      vehicleName: "BOLERO MAHINDRA & MAHINDRA",
      vehicleNo: "MH09CM9248",
      vehicleType: "PVT CAR",
      __1: "",
      __2: "",
      __3: "",
      _id: "628df39c3fcd87b668837606",
    },
  ]);
                  ...
                  .map((row) => {
                    return (
                      ...
                      >
                        ...
                        <TableCell>
                          <Button
                            style={{ margin: 4, padding: 2, width: 40 }}
                            variant="contained"
                            size="small"
        ...
        >
          ...
          <div className={classes.form}>
            ...
            <TextField
              ...
              required
              error={
                capacity.match(/[^0-9]/g) ? "Please enter valid capacity" : ""
              }
              helperText={
                capacity.match(/[^0-9]/g) ? "Please enter valid capacity" : ""
              }
            ...
            <TextField
              ...
              required
              error={
                manufactureYear.match(/[^0-9]/g)
                  ? "Please enter valid manufacture year"
                  : ""
              }
              helperText={
                manufactureYear.match(/[^0-9]/g)
        ...
        >
          ...
          <div className={classes.form}>
            ...
            <TextField
              ...
              required
              error={
                maintenaceDescription.match(/[^A-Za-z0-9]/g)
                  ? "Please enter valid vehicle no"
                  : ""
              }
              helperText={
              ...
              onChange={(e) => {
                setmaintenaceDescription(e.target.value);
              }}
            />
            <TextField
              style={{ margin: 8 }}
              ...
              onChange={(e) => {
                setmaintenaceCost(e.target.value);
              }}
            />
            <TextField
              style={{ margin: 8 }}
              ...
              required
              error={
                maintenacePlace.match(/[^A-Za-z0-9]/g)
                  ? "Please enter valid vehicle no"
                  : ""
              }
              helperText={
              ...
              onChange={(e) => {
                setmaintenacePlace(e.target.value);
              }}
            />
            <TextField
              style={{ margin: 8 }}
              ...
              required
              error={
                maintenacePlaceNo.match(/[^A-Za-z0-9]/g)
                  ? "Please enter valid vehicle no"
                  : ""
              }
              helperText={
              ...
              onChange={(e) => {
                setmaintenacePlaceNo(e.target.value);
              }}
            />
