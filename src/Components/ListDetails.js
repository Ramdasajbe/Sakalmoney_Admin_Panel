  ...
  const [data, setData] = useState([
    {
      ...
      status: "Active",
      updatedBy: [],
      vehicleName: "DREAM YUGA HONDA",
      vehicleNo: "MH12LW3309",
      vehicleType: "Two Wheeler",
      __1: "",
      __2: "",
      __3: "",
      _id: "628df39c3fcd87b66883760d",
    },
    {
      "": "",
      agencyName: "SAKAAL PAPERS LTD.",
      ...
      status: "Active",
      updatedBy: [],
      vehicleName: "CT 100 BAJAJ",
      vehicleNo: "MH09AU0545",
      vehicleType: "Two Wheeler",
      __1: "",
      __2: "",
      __3: "",
      _id: "628df39c3fcd87b66883760c",
      // [[Prototype]]: Object,
    },
  ]);
                      ...
                      .map((row) => {
                        return (
                          ...
                          >
                            ...
                            <TableCell>
                              {moment(row.maintenanceStartDate).format(
                                "DD-MMM-YYYY hh:mm:a"
                              )}
                            </TableCell>
                            <TableCell>
                              {row.maintenanceEndDate
                                ? moment(row.maintenanceEndDate).format(
                                    "DD-MMM-YYYY hh:mm:a"
                                  )
                                : "-"}{" "}
                              {row.make}
        ...
        >
          ...
          <div className={classes.form}>
            ...
            <TextField
              ...
              required
              error={
                maintenancePlace.match(/[^A-Za-z0-9]/g)
                  ? "Please enter valid Place Name"
                  : ""
              }
              helperText={
                maintenancePlace.match(/[^A-Za-z0-9]/g)
            ...
            <TextField
              ...
              required
              error={
                maintenancePlaceNo.match(/[^A-Za-z0-9]/g)
                  ? "Please enter valid Maintenance Place no"
                  : ""
              }
              helperText={
                maintenancePlaceNo.match(/[^A-Za-z0-9]/g)
            ...
            <TextField
              ...
              required
              error={
                odoMeterReadingStart.match(/[^0-9]/g)
                  ? "Please enter valid odo Meter Reading"
                  : ""
              }
              helperText={
                odoMeterReadingStart.match(/[^0-9]/g)
        ...
        >
          ...
          <div className={classes.form}>
            ...
            <TextField
              ...
              required
              error={
                odoMeterReadingEnd.match(/[^0-9]/g)
                  ? "Please enter valid odo Meter Reading"
                  : ""
              }
              helperText={
