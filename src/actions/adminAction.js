...
export const getcheckInOutList = data => {
    return {
        type:'GET_VEHICLE_CHECKINOUT_LIST',
        payload:data
    }
}
...
export function setRequestStatusAdminDataReports(data) {
    return dispatch => {
        let myHeaders = new Headers();
        myHeaders.append("Content-Type", "application/json");
        console.log(data)
...
export function getDriverUserListData() {
    return dispatch => {
        let myHeaders = new Headers();
        myHeaders.append("Content-Type", "application/x-www-form-urlencoded");
        let urlencoded = new URLSearchParams();
...
export function getadminvehicleCheckInOutData(data){
    return dispatch => {    
        let myHeaders = new Headers();
        myHeaders.append("Content-Type", "application/x-www-form-urlencoded");

        let urlencoded = new URLSearchParams();
        urlencoded.append("vehicleCheckinStartDateTime",data.vehicleCheckinStartDateTime)
        urlencoded.append("vehicleCheckinEndDateTime",data.vehicleCheckinEndDateTime)
        ...
        return fetch(BASE_URL + '/vehiclecheckincheckout/getcheckinvehicle/filterwithdate', requestOptions).then(response => response.json()).then(res => {
            dispatch(getcheckInOutList(res));
