...
export function getVehicleListData(data) {
  return (dispatch) => {
    ...
    return fetch(BASE_URL + "/vehicle/getcarlist", requestOptions)
...
export function getallvehicleListData() {
  return (dispatch) => {
    ...
    return fetch(BASE_URL + "/vehicle/getallcarlist", requestOptions)
      .then((response) => response.json())
      .then((res) => {
        dispatch(getVehicleList(res));
        return res;
...
export function addVehicleListData(data) {
  ...
  return (dispatch) => {
    ...
    return fetch(BASE_URL + "/vehicle/vehicleI", requestOptions)
      .then((response) => response.json())
      .then((res) => {
...
export function updateVehicleListData(data) {
  return (dispatch) => {
    ...
    return fetch(BASE_URL + "/vehicle/vehicleU", requestOptions)
      .then((response) => response.json())
      .then((res) => {
        dispatch(getallvehicleListData());
      })
...
export function AddMaintenanceData(data) {
  ...
  return (dispatch) => {
    ...
    return fetch(
      BASE_URL + "/vehiclemaintenance/insertvehiclemaintenance",
      requestOptions
    )
      .then((response) => response.json())
      .then((res) => {
...
export function EndMaintenanceData(data) {
  ...
  return (dispatch) => {
    ...
    return fetch(
      BASE_URL + "/vehiclemaintenance/vehiclebackfrommaintenance",
      requestOptions
    )
      .then((response) => response.json())
      .then((res) => {
...
export function AddPetrolExpenseData(data) {
  return (dispatch) => {
    ...
    return fetch(
      BASE_URL + "/vehiclepetrolfeeling/insertvehiclepetrolfeeling",
      requestOptions
    )
      .then((response) => response.json())
      .then((res) => {
...
export function setCancelStatusData(data) {
  return (dispatch) => {
    ...
    return fetch(BASE_URL + "/journey/rejectCancelStatus", requestOptions)
      .then((response) => response.json())
      .then((res) => {
        dispatch(setTravellerRequest(res));
        return res;
...
export function getTravellerLatestJourneyData(requestBody) {
  return (dispatch) => {
    ...
    return fetch(BASE_URL + "/journey/travellerLatestJourney", requestOptions)
      .then((response) => response.json())
      .then((res) => {
...
export function getTravellerAllPreviousJourneyData(requestBody) {
  return (dispatch) => {
    ...
    return fetch(BASE_URL + "/journey/previousRidesForTraveler", requestOptions)
      .then((response) => response.json())
      .then((res) => {
...
export function getTravellerAllUpcomingJourneyData(requestBody) {
  return (dispatch) => {
    ...
    return fetch(BASE_URL + "/journey/upcomingRidesForTraveler", requestOptions)
      .then((response) => response.json())
      .then((res) => {
...
export function getTravellerPreviousRidesData(requestBody) {
  return (dispatch) => {
    ...
    return fetch(BASE_URL + "/journey/driversPreviousJourney", requestOptions)
      .then((response) => response.json())
      .then((res) => {
...
export function getTravellerUpcomingPreviousRidesData(requestBody, date) {
  return (dispatch) => {
    ...
    return fetch(
      BASE_URL + "/journey/travelerUpcomingPreviousJourney",
      requestOptions
    )
      .then((response) => response.json())
      .then((res) => {
...
export function getTravellerUpcomingRidesData(requestBody) {
  return (dispatch) => {
    ...
    return fetch(
      BASE_URL + "/journey/treavellerUpcomingJourney",
      requestOptions
    )
      .then((response) => response.json())
      .then((res) => {
...
export function getVehicleMaintenanceData(requestBody) {
  return (dispatch) => {
    ...
    return fetch(
      BASE_URL + "/vehiclemaintenance/getvehiclemaintenancebyvehicle",
      requestOptions
    )
      .then((response) => response.json())
      .then((res) => {
...
export function setStartJourneyData(data) {
  return (dispatch) => {
    ...
    return fetch(BASE_URL + "/journey/startJourney", requestOptions)
      .then((response) => response.json())
      .then((res) => {
...
export function setEndJourneyData(data) {
  return (dispatch) => {
    ...
    return fetch(BASE_URL + "/journey/endJourney", requestOptions)
      .then((response) => response.json())
      .then((res) => {
        // dispatch(getDriverLatestJourney(res));
        return res;
...
export function getPetrolExpenseListData(data) {
  return (dispatch) => {
    ...
    return fetch(
      BASE_URL + "/vehiclepetrolfeeling/getvehiclepetrolfeelingbyvehicle",
      requestOptions
    )
      .then((response) => response.json())
      .then((res) => {
...
export function settravellersExtendJourneyData(data) {
  return (dispatch) => {
    ...
    return fetch(BASE_URL + "/journey/extendrequest", requestOptions)
      .then((response) => response.json())
      .then((res) => {
...
export function extendrequestallocatedriverlistData(requestBody) {
  return (dispatch) => {
    ...
    return fetch(
      BASE_URL + "/journey/extendrequestallocatedriver",
      requestOptions
    )
      .then((response) => response.json())
      .then((res) => {
...
export function DealocationdriverListData(data) {
  ...
  return (dispatch) => {
    ...
    return fetch(
      BASE_URL + "/journey/extendrequestdeallocatedriverjourney",
      requestOptions
    )
      .then((response) => response.json())
      .then((res) => {
...
export function extendrequestallocatevehiclelistData(requestBody) {
  return (dispatch) => {
    ...
    return fetch(
      BASE_URL + "/journey/extendrequestallocatevehicle",
      requestOptions
    )
      .then((response) => response.json())
      .then((res) => {
...
export function DealocationvelicleListData(data) {
  return (dispatch) => {
    ...
    return fetch(
      BASE_URL + "/journey/extendrequestdeallocatevehiclejourney",
      requestOptions
    )
      .then((response) => response.json())
      .then((res) => {
...
export function extendRequestApproveData(data) {
  return (dispatch) => {
    ...
    return fetch(BASE_URL + "/journey/extendapproveride", requestOptions)
      .then((response) => response.json())
      .then((res) => {
        dispatch(getvehicleDealocatedData(res));
...
export function getJourneyfetchdata(data) {
  return (dispatch) => {
    ...
    return fetch(BASE_URL + "/journey/journeyfetch", requestOptions)
      .then((response) => response.json())
      .then((res) => {
...
export function getProjectheaddata(data) {
  return (dispatch) => {
    ...
    return fetch(BASE_URL + "/user/userV", requestOptions)
      .then((response) => response.json())
      .then((res) => {
...
export function setheadApproveRejectdata(data) {
  return (dispatch) => {
    ...
    return fetch(BASE_URL + "/journey/headapproveandreject", requestOptions)
      .then((response) => response.json())
      .then((res) => {
